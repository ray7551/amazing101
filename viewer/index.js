 ...
 */
class Viewer {  
  constructor(canvas, thumbCanvas, width, height, gfx, thumbGfx) {
    this.image = null;
    this.scale = 1;
    ...
    this.thumbCanvas.width = Viewer.thumbWidth;
    this.thumbCanvas.height = Viewer.thumbHeight;
    this.gfx = gfx;
...
Viewer.thumbWidth = 150;
Viewer.thumbHeight = 150;
Viewer.zoomStep = .1;
Viewer.zoomMax = 5;
Viewer.zoomMin = .001;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let viewer = new Viewer(canvas, thumbCanvas, 800, 600, new Gfx(canvas, new Transform2D()), new Gfx(thumbCanvas));
